<!-- 
Write  PHP-PDO (PHP Data Objects) interface script that connects with one of the tables of your 
...
<?php
    ...
    try {
        ...
        if (isset($_POST['insert'])) {
            ...
            $stmt = $conn->prepare("INSERT INTO member (FirstName, LastName) VALUES (:firstName, :lastName)");
        ...
        if (isset($_POST['update'])) {
            ...
            $firstName = $_POST['firstName'];
            $stmt = $conn->prepare("UPDATE member SET FirstName = :firstName WHERE MemberID = :memberID");
        ...
        if (isset($_POST['select'])) {
            ...
            if (count($result) > 0) {
                ...
                foreach ($result as $row) {
                    echo "<tr><td>" . htmlspecialchars($row["MemberID"]) . "</td><td>" . htmlspecialchars($row["FirstName"]) . "</td><td>" . htmlspecialchars($row["LastName"]) . "</td></tr>";
                }
                echo "</table>";
            } else {
                echo "0 results";
